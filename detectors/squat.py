...
class SquatDetector(BaseExercise):
    ...
    def process(self,landmarks):
        ...
        key_landmark_visibility = landmarks[hip_idx].visibility >= self.MIN_VISIBILITY and landmarks[knee_idx].visibility >= self.MIN_VISIBILITY and landmarks[ankle_idx].visibility >= self.MIN_VISIBILITY
        if key_landmark_visibility:
